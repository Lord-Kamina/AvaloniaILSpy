    ...
    class MemberSearchStrategy : AbstractSearchStrategy
    {
        ...
        public override void Search(PEFile module, CancellationToken cancellationToken)
        {
            ...
            if (searchKind == MemberSearchKind.All || searchKind == MemberSearchKind.Type)
            {
                ...
                {
                    cancellationToken.ThrowIfCancellationRequested();
                    var languageSpecificName = language.GetEntityName(module, handle, fullNameSearch, omitGenerics);
            ...
            if (searchKind != MemberSearchKind.All && searchKind != MemberSearchKind.Member &&
                searchKind != MemberSearchKind.Event) return;
            {
